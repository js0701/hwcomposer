...
KMSCubeLayerRenderer::KMSCubeLayerRenderer(struct gbm_device *dev)
                                           :GLLayerRenderer(dev)
{

}

KMSCubeLayerRenderer::~KMSCubeLayerRenderer()
{

}

bool KMSCubeLayerRenderer::Init(uint32_t width, uint32_t height, uint32_t format)
{
   if(format != GBM_FORMAT_XRGB8888) return false;
   if(!GLLayerRenderer::Init(width, height, format)) return false;
...
void KMSCubeLayerRenderer::glDrawFrame() {
